...
@include('common.errors')
    ...
    <div class="main-card mb-3 card">
	        ...
	        <div class="card-body px-2 py-0">
	        	<form action="{{ route('fm.earnings.search')}}" method="post">
					@csrf
	        	...
	        	<table class="mb-0 table table-striped table-hover">
	                <thead>
		                <tr>
		                    <th>#</th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'id'))}}">ID <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'investmentID'))}}">Investment ID <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'name'))}}">Investor Name <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'title'))}}">Investment Vehicle <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'INVamount'))}}">Investment Amount <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'status'))}}">Status <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'issue'))}}">Date Issued <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'percent'))}}">Return Percent <i class="fa fa-fw fa-sort"></i></a></th>
		                    <th><a href="{{route('fm.earnings.index',sort_by($filterArray,'amount'))}}">Amount Earned <i class="fa fa-fw fa-sort"></i></a></th>
		                </tr>
	                </thead>
	                <tbody>
